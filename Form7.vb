...
Public Class Form7
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        If CheckBox2.Checked = True Then
            TextBox1.Text = Val(TextBox1.Text) + 80
            TextBox3.Text = "+"
        Else
            TextBox1.Text = Val(TextBox1.Text) - 80
            TextBox3.Text = ""
    ...
    Private Sub CheckBox3_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox3.CheckedChanged
        If CheckBox3.Checked = True Then
            TextBox1.Text = Val(TextBox1.Text) + 60
            TextBox4.Text = "+"
        Else
            TextBox1.Text = Val(TextBox1.Text) - 60
            TextBox4.Text = ""
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim sql2 As New String("INSERT INTO frozenteklif (pasta,balonseti,tabakseti,masaortusu,bayrakset,pinyata,dörtlübalon,ücret) values ('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}')")

        sql2 = String.Format(sql2, TextBox2.Text, TextBox3.Text, TextBox4.Text, TextBox5.Text, TextBox6.Text, TextBox7.Text, TextBox8.Text, TextBox1.Text)
